...
\renewcommand{\section}[1]{\pagebreak[3]%
    ...
    \noindent\llap{\scshape\smash{\parbox[t]{%
        \marginparwidth}{%
            ...
            \draw[color1,line width=1.5pt] ([yshift=2ex, xshift=-2ex]{pic cs:end-\thetmp}|-{pic cs:start-\thetmp})
             -- ([yshift=-1ex, xshift=-2ex]{pic cs:end-\thetmp});
